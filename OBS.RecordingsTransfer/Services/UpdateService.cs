...
public class UpdateService
{
    ...
    public async Task<string> DownloadInstallerAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        var folder = Path.Combine(Path.GetTempPath(), "OBS-Recordings-Update");
    ...
    private const string LegacyInstallerAssetPrefix = "ODBC-Recordings-Transfer-";
    ...
    private static bool IsInstallerAsset(string name)
    {
        ...
        if ((name.StartsWith(UpdateConfig.InstallerAssetPrefix, StringComparison.OrdinalIgnoreCase)
             || name.StartsWith(LegacyInstallerAssetPrefix, StringComparison.OrdinalIgnoreCase))
    ...
    private static HttpClient CreateClient()
    {
        ...
        client.DefaultRequestHeaders.UserAgent.Add(
            new ProductInfoHeaderValue("OBS-Recordings-Transfer", GetCurrentVersion().ToString()));
